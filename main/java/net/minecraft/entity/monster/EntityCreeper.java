...
public class EntityCreeper extends EntityMob {
	...
	public void onUpdate() {
		if (this.isEntityAlive()) {
			...
			if (i > 0 && this.timeSinceIgnited == 0) {
				this.playSound(Main.MODID + ":creeperPrimed", 1.0F, 1.0F);
			}
	...
	private void func_146077_cc() {
		if (!this.worldObj.isRemote) {
			...
			try {
				explosionPower = Integer.parseInt(this.worldObj.getGameRules().getGameRuleStringValue("creeperExplosionPower"));
			} catch(NumberFormatException e) {
				explosionPower = 5;
			}

			if (this.getPowered()) {
				this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float) (this.explosionRadius * explosionPower * 1.8f), flag);
			} else {
				this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float) (this.explosionRadius * explosionPower), flag);
			}
